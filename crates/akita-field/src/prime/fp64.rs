...
impl<const P: u64> Valid for Fp64<P> {
...
impl<const P: u64> AkitaSerialize for Fp64<P> {
...
impl<const P: u64> AkitaDeserialize for Fp64<P> {
    type Context = ();
    ...
    fn deserialize_with_mode<R: Read>(
        ...
        let out = if matches!(validate, Validate::Yes) {
            ...
            Self(Self::reduce_u128(x as u128))
        };
        Ok(out)
    }
}
